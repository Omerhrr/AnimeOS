...
export interface SliceAudioCue {
  ...
  voiceDelivery?: string | null;  // standing direction (null = state-aware auto)
  voiceNote?: string | null;      // directorial note
  voiceCast?: string | null;      // cast artist that performed the take
}
